...
public class Accountant_Eearning_Allocation extends javax.swing.JFrame {
   ...
   String class_teacher_id = null;  
    ...
    //passing user id
    private static Accountant_Eearning_Allocation Obj = null;
    ...
    String        get_Deducation_id_toUpdate2 = null;
        ...
        Accountant_Eearning_Allocation() {
        initComponents();
    ...
    public void printPassed_id() {
      ...
      public void infoicon(){
       try {conn = DBConnection.getConnction();
            ...
            Logger.getLogger(Accountant_Eearning_Allocation.class.getName()).log(Level.SEVERE, null, ex);
          }
       ...
       public void Count_Roomtype() {
        ...
        } catch (SQLException ex) {Logger.getLogger(Accountant_Eearning_Allocation.class.getName()).log(Level.SEVERE, null, ex);  }
    ...
    public void ShowRoomType_onTable() {//school srtucture
        try {
         ...
         try {
            conn = DBConnection.getConnction();
            String sql = " SELECT Earning_name,Earning_amount, Date  FROM  earning";
    ...
    private void initComponents() {
        ...
        Complaint_view.add(Deducation_Search_Employee, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 650, 90, -1));
        ...
        Add_price3.setText("  Earning   Processing");
        ...
        jPanel35.add(jLabel209, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 0, 140, 50));
        ...
        jPanel35.add(jLabel215, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 0, 120, 50));
        ...
        jPanel35.add(jLabel216, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 0, 100, 50));
        ...
        jPanel35.add(jLabel225, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 0, 150, 50));

        Complaint_view.add(jPanel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 1240, 50));
        ...
        Complaint_view.add(jScrollPane25, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 1240, 470));
        ...
        Complaint_view.add(table_holder_bg9, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 1340, 550));
        ...
        Complaint_view.add(table_holder_bg8, new org.netbeans.lib.awtextra.AbsoluteConstraints(-180, 120, 1340, 550));
        ...
        jLabel228.setText("Earning  Name");
        ...
        panal_ADD_Dedications.add(Earning_Name, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 430, 380, 30));
        ...
        Count_title40.setText("view List");
        ...
        jLabel222.setText("Earning  Name");
        ...
        jLabel230.setText("Earning  Amount");
        ...
        jLabel231.setText("Earning  Date");
        ...
        jLabel232.setText("Earning  Amount");
        panal_ADD_Dedications.add(jLabel232, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 500, 150, 30));
        panal_ADD_Dedications.add(Earning_Amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 500, 380, 30));
        ...
        Payables_Deducations.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 960, 430));
    ...
    private void minize_lbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minize_lbMouseClicked
        this.setExtendedState(Accountant_Eearning_Allocation.ICONIFIED);
  ...
  public void Delecte_expenses() {
    ...
    private void updateDeducationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateDeducationMouseClicked
        ...
        try {
                 conn = DBConnection.getConnction();
                String sql = "UPDATE  earning SET Earning_name =?,Earning_amount =?,Date =?  WHERE Earning_id =? ";
                pps5 = conn.prepareStatement(sql);
                 pps5.setString(1 , Earning_Name.getText());
                 pps5.setString(2 , Earning_Amount.getText());
    ...
    private void Add_DeducationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add_DeducationMouseClicked
        ...
        JOptionPane.showMessageDialog(null, "Earning  name  is Empty");
        }else if( Earning_Amount.getText().isEmpty()){
          JOptionPane.showMessageDialog(null, "Earning  amount is Empty");
         }else {
         ...
         java.sql.Date sqldate1 = new java.sql.Date(date1.getTime());
          ...
          try {
             conn = DBConnection.getConnction();
             String sql = "INSERT INTO earning  (Earning_name,Earning_amount,Date) VALUES (?,?,?)";
            pps = conn.prepareStatement(sql);
            pps.setString(1 , Earning_Name.getText());
            pps.setString(2 , Earning_Amount.getText());
    ...
    private void Add_Earning_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add_Earning_buttonMouseClicked
             try {
            conn = DBConnection.getConnction();
            String sql = "SELECT Earning_name,Earning_amount  FROM  earning";
            pps11 = conn.prepareStatement(sql);
            rs11= pps11.executeQuery();
    ...
    private void DelecteDeducation1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DelecteDeducation1MouseClicked
          ...
          try {
            conn = DBConnection.getConnction();
            String sql = "SELECT Earning_name FROM earning INNER JOIN payables ON earning.Earning_id = payables.Earning_id INNER JOIN employee ON employee.user_login_id = payables.user_login_id WHERE  payables.user_login_id =?";
            pps11 = conn.prepareStatement(sql);
    ...
    private void ASSIGN_Deduction_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ASSIGN_Deduction_ButtonMouseClicked
        ...
        if (Deducation_Assign_selected.equals("none")) {
          ...
          try {
             conn = DBConnection.getConnction();
             String sql = "SELECT  * FROM earning WHERE Earning_name = ? AND Earning_amount  = ?  ";
            pps4 = conn.prepareStatement(sql);
    ...
    private void UN_AssignMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UN_AssignMouseClicked
          ...
          try {
            conn = DBConnection.getConnction();
            String sql = "SELECT  * FROM earning WHERE Earning_name = ? ";
            pps4 = conn.prepareStatement(sql);
   ...
   try {
            ...
            pps4.setString(2 , get_Deducation_Assign_id);
             ...
             rs4 = pps4.executeQuery();
            //  GET_Payable_id = rs4.getString("earning_joint_id");
              if(rs4.next()){
    ...
    public void Update_Earning(){
      Date date1 = new Date();
         java.sql.Date sqldate1 = new java.sql.Date(date1.getTime());
          ...
          try {
             conn = DBConnection.getConnction();
             String sql = "UPDATE payables SET Earning_id =?  WHERE  Payables_id =?";
            pps = conn.prepareStatement(sql);
            pps.setString(1 , get_Deducation_Assign_id);
            pps.setString(2 , GET_Payable_id);
            pps.executeUpdate();
            JOptionPane.showMessageDialog(null, "Successfully Saved..." );
            Earning_Name.setText(null);
            Earning_Amount.setText(null);
    ...
    public void Select_after_inserting(){
         ...
         try {
            conn = DBConnection.getConnction();
            String sql = "SELECT Earning_name FROM earning INNER JOIN earning_joint ON earning.Earning_id = earning_joint.Earning_id INNER JOIN employee ON employee.user_login_id = earning_joint.user_login_id WHERE  earning_joint.user_login_id =?";
            pps11 = conn.prepareStatement(sql);
            pps11.setString(1, get_Employee_id);
            rs11= pps11.executeQuery();
            Deducation_Assigned_table.setModel(DbUtils.resultSetToTableModel(rs11));
     ...
     public static Accountant_Eearning_Allocation getObj() {  //public method for instance Restriction
        if (Obj == null) {
            Obj = new Accountant_Eearning_Allocation();
        }
        return Obj;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Accountant_Eearning_Allocation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Accountant_Eearning_Allocation().setVisible(true);
            }
        });
    }
