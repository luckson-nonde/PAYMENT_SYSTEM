...
public class Reception_Student_View extends javax.swing.JFrame {
   ...
   String class_teacher_id = null;  
    ...
    //passing user id
    private static Reception_Student_View Obj = null;
   ...
   try {
    ...
    private void initComponents() {
        ...
        admin_btn.add(jLabel42, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 130, 40));

        jPanel1.add(admin_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 170, 40));
    ...
    private void Delecte23MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Delecte23MouseClicked
     ...
     public static Reception_Student_View getObj() {  //public method for instance Restriction
        if (Obj == null) {
            Obj = new Reception_Student_View();
        }
        return Obj;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reception_Student_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reception_Student_View().setVisible(true);
            }
        });
    }
