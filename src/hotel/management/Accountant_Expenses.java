...
public class Accountant_Expenses extends javax.swing.JFrame {
   ...
   String class_teacher_id = null;  
    ...
    //passing user id
    private static Accountant_Expenses Obj = null;
      ...
      public void infoicon(){
       ...
       public void Count_Roomtype() {
           ...
           try {
            ...
            pps7 = conn.prepareStatement("SELECT  count(Expenses_id) FROM   expenses");
        ...
        } catch (SQLException ex) {Logger.getLogger(Accountant_Expenses.class.getName()).log(Level.SEVERE, null, ex);  }
          ...
          // 
            ...
            conn = DBConnection.getConnction();
            pps8 = conn.prepareStatement("SELECT  count(Expenses_id) FROM   expenses  WHERE date=? ");
...
//students_tata
    ...
    private void initComponents() {
        ...
        Add_price6.setText("  Expenses");
        Add_price6.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Add_price6MouseClicked(evt);
            }
        });
        Complaint_view.add(Add_price6, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 640, 100, 40));
        ...
        Complaint_view.add(Delecte12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 620, 430, 70));
        ...
        Complaint_view.add(jScrollPane25, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 780, 470));
        ...
        lb_payment_pending.setText("All   Expenses");
        ...
        lb_students.setText("   Daily Expenses");
        ...
        jLabel80.setText("   Monthly Expenses");
    ...
    private void minize_lbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minize_lbMouseClicked
        this.setExtendedState(Accountant_Expenses.ICONIFIED);
    ...
    private void Add_PaidServicesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add_PaidServicesMouseClicked
        ...
        int New_amount  = Integer.parseInt(Amount.getText());
          ...
          try {
             conn = DBConnection.getConnction();
             String sql = "INSERT INTO expenses (payment_to,payment_method, description,Amount,Date,Due_date) VALUES (?,?,?,?,?,?)";
            pps = conn.prepareStatement(sql);
            pps.setString(1 , Payment_txt.getText());
            pps.setString(2 , Payment_method.getText());
            pps.setString(3, description.getText());
            pps.setInt(4 , New_amount);
            pps.setDate(5 ,sqldate );
            pps.setDate(6 ,sqldate1 );
            pps.executeUpdate();
  ...
  public void Delecte_expenses() {
    ...
    private void lb_student_bgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_student_bgMouseClicked
        ...
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE date =? ";
            pps2 = conn.prepareStatement(sql);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE  YEARWEEK(date) = YEARWEEK(NOW())";
            pps2 = conn.prepareStatement(sql);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
        } catch (SQLException ex) {
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE date = (getdate() as Date) AND Status =?";
            pps6 = conn.prepareStatement(sql);
        ...
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT  sum(Amount)   FROM expenses WHERE date = cast(getdate() as Date) AND Status =?";
            pps7 = conn.prepareStatement(sql);
          //  pps7.setDate(1, sqldate);
            pps7.setString(1, Status);
            rs7 = pps7.executeQuery();
           if(rs7.next()){
            jLabel10.setText("K :" +  rs7.getString("sum(Amount)"));
     ...
     public static Accountant_Expenses getObj() {  //public method for instance Restriction
        if (Obj == null) {
            Obj = new Accountant_Expenses();
        }
        return Obj;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Accountant_Expenses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Accountant_Expenses().setVisible(true);
            }
        });
    }
