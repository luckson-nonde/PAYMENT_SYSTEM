...
public class Accountant_Home_Page extends javax.swing.JFrame {
 ...
 String  class_teacher_class  = null;
   ...
   String global_user_id = null; // A variable thats holds the id 
    ...
    private static Accountant_Home_Page Obj = null;
    
    
    
   Accountant_Home_Page() {
        initComponents();
 ...
 //*********************************************************GETTING CURRENT USER ID
    ...
    public void printUserID() {
       ...
       try {conn = DBConnection.getConnction();
            ...
            Logger.getLogger(Accountant_Home_Page.class.getName()).log(Level.SEVERE, null, ex);
         ...
         public void count_lessonplan(){
           ...
           // SELECT * FROM `expenses` WHERE YEARWEEK(date) = YEARWEEK(NOW());
    ...
    private void initComponents() {
        ...
        report_panelBTN.add(jLabel88, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 0, 30, 50));
        ...
        jLabel26.setText("  Income  Entry");
        report_panelBTN.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 160, 50));

        frontSide_btn_holder.add(report_panelBTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 210, 50));
        ...
        archived_booking.add(jLabel85, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 0, 30, 40));
        ...
        frontSide_btn_holder.add(report_panelBTN1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 210, 60));
        ...
        jLabel23.setText("  Make   Payments");
        jLabel23.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel23MouseClicked(evt);
            }
        });
        report_panelBTN2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 150, 60));
        ...
        frontSide_btn_holder.add(report_panelBTN2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 210, 60));
        ...
        report_panelBTN3.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 130, 60));
        ...
        frontSide_btn_holder.add(report_panelBTN3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 550, 210, 60));
        ...
        report_panelBTN5.add(jLabel94, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 0, 30, 50));
        ...
        jLabel21.setText(" Earning Allocation");
        report_panelBTN5.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 140, 50));

        frontSide_btn_holder.add(report_panelBTN5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 210, 50));
        ...
        jLabel27.setText(" Expense Entry");
        report_panelBTN6.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 140, 60));
        ...
        frontSide_btn_holder.add(report_panelBTN6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 310, 210, 60));
    ...
    private void minize_lbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minize_lbMouseClicked
        this.setExtendedState(Accountant_Home_Page.ICONIFIED);
    ...
    private void report_panelBTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_report_panelBTNMouseClicked
       ...
       Accountant_Income.getObj().setVisible(true);
       //passing user id 
        Accountant_Income.getObj().setPassed_id(pass_user_id);
        Accountant_Income.getObj().printPassed_id();
        this.dispose();   
    ...
    private void report_panelBTN1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_report_panelBTN1MouseClicked
        ...
        Teacher_Student_View myview  = new Teacher_Student_View();
        this.dispose();
    ...
    private void report_panelBTN2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_report_panelBTN2MouseClicked
         Accountant_Payments1.getObj().setVisible(true);
         
       //passing user id 
        Accountant_Payments1.getObj().setUserID(pass_user_id);
        Accountant_Payments1.getObj().printUserID();
      // this.dispose();
    ...
    private void report_panelBTN3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_report_panelBTN3MouseClicked
        Accountant_Dedication_Entry.getObj().setVisible(true);
         
       //passing user id Accountant_Eearning_Entry
        Accountant_Dedication_Entry.getObj().setPassed_id(pass_user_id);
        Accountant_Dedication_Entry.getObj().printPassed_id();
        this.dispose();
 ...
 /*
    ...
    private void report_panelBTN5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_report_panelBTN5MouseClicked
         Accountant_Eearning_Entry.getObj().setVisible(true);
         
       //passing user id Accountant_Eearning_Entry
        Accountant_Eearning_Entry.getObj().setPassed_id(pass_user_id);
        Accountant_Eearning_Entry.getObj().printPassed_id();
        this.dispose();
    ...
    private void report_panelBTN6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_report_panelBTN6MouseClicked
        ...
        Accountant_Expenses.getObj().setVisible(true);
         
       //passing user id Teacher_ResultView_Page
        Accountant_Expenses.getObj().setPassed_id(pass_user_id);
        Accountant_Expenses.getObj().printPassed_id();
        this.dispose();
    ...
    private void lb_payment_bgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_payment_bgMouseClicked
     ...
     public static Accountant_Home_Page getObj() {  //public method for instance Restriction
        if (Obj == null) {
            Obj = new Accountant_Home_Page();
        }
        return Obj;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Accountant_Home_Page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Accountant_Home_Page().setVisible(true);
            }
        });
    }
