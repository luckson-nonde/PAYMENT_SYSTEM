...
public class Teacher_Payment_view extends javax.swing.JFrame {
      ...
      ResultSet rs, rs1, rs2, rs3, rs4, rs5, rs6, rs7, rs8, rs9, rs10, rs11, rs12 ,rs13= null;
              ...
              //passing user id
            private static Teacher_Payment_view Obj = null;
    ...
    private void initComponents() {
        ...
        getContentPane().add(Main_holder, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -10, 1380, 780));
    ...
    private void txtSearchMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtSearchMouseEntered
     ...
     public static Teacher_Payment_view getObj() {  //public method for instance Restriction
        if (Obj == null) {
            Obj = new Teacher_Payment_view();
        }
        return Obj;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teacher_Payment_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Teacher_Payment_view().setVisible(true);
            }
        });
    }
