...
public class Accountant_ID_Card_maker extends javax.swing.JFrame {
    ...
    //passing user id
    private static Accountant_ID_Card_maker Obj = null;
    private String passed_user_id;


    
    Accountant_ID_Card_maker() {
        initComponents();
   ...
   public static void SaveScreenShot(Component com) throws Exception{
    ...
    private void minize_lbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minize_lbMouseClicked
        this.setExtendedState(Accountant_ID_Card_maker.ICONIFIED);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      ...
      public static Accountant_ID_Card_maker getObj() {  //public method for instance Restriction
        if (Obj == null) {
            Obj = new Accountant_ID_Card_maker();
        }
        return Obj;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Accountant_ID_Card_maker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Accountant_ID_Card_maker().setVisible(true);
            }
        });
    }
