...
public class Admin_Expenses_Approval extends javax.swing.JFrame {
   ...
   String class_teacher_id = null;  
    ...
    //passing user id
    private static Admin_Expenses_Approval Obj = null;
    ...
    public void printPassed_id() {
      ...
      public void infoicon(){
       try {conn = DBConnection.getConnction();
            ...
            Logger.getLogger(Admin_Expenses_Approval.class.getName()).log(Level.SEVERE, null, ex);
          }
    ...
    //  students_tata
           ...
           try {
            ...
            pps7 = conn.prepareStatement("SELECT  count(Expenses_id) FROM   expenses WHERE Status = \"Pending\" ");
            rs7 = pps7.executeQuery();
            if (rs7.next()) {
                String sum = rs7.getString("count(Expenses_id)");
               
                jLabel77.setText(sum);
            }
        } catch (SQLException ex) {Logger.getLogger(Admin_Expenses_Approval.class.getName()).log(Level.SEVERE, null, ex);  }
           ...
           try {
            ...
            conn = DBConnection.getConnction();
            pps11 = conn.prepareStatement("SELECT  Sum(Amount) FROM   expenses WHERE Date = ?");
            pps11.setDate(1 , sqldate);
            rs11= pps11.executeQuery();
            if (rs11.next()) {
                String sum = rs11.getString("Sum(Amount)");
          ...
          try {
            ...
            conn = DBConnection.getConnction();
            pps11 = conn.prepareStatement("SELECT  Sum(Amount) FROM   expenses WHERE YEARWEEK(Date) = YEARWEEK(NOW())");
            rs11= pps11.executeQuery();
            if (rs11.next()) {
                String sum = rs11.getString("Sum(Amount)");
           ...
           try {
            ...
            conn = DBConnection.getConnction();
            pps11 = conn.prepareStatement("SELECT  Sum(Amount) FROM   expenses WHERE MONTH(Date) = MONTH(NOW())");
            rs11= pps11.executeQuery();
            if (rs11.next()) {
                String sum = rs11.getString("Sum(Amount)");
          ...
          // 
            ...
            conn = DBConnection.getConnction();
            pps8 = conn.prepareStatement("SELECT  count(Expenses_id) FROM   expenses  WHERE date=? AND Status = \"Pending\" ");
             pps8.setDate(1 , sqldate);
            rs8 = pps8.executeQuery();
            if (rs8.next()) {
                String sum = rs8.getString("count(Expenses_id)");
                mulit_counter.setText(sum);
...
//students_tata
         ...
         try {
            ...
            conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE MONTH(Date) = MONTH(NOW())");
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
                mulit_counter.setText(sum);
    ...
    public void ShowRoomType_onTable() {//school srtucture
        ...
        try {
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses";
    ...
    private void initComponents() {
        ...
        lb_payment_pending4 = new javax.swing.JLabel();
        lb_payment_pending5 = new javax.swing.JLabel();
        lb_payment_pending6 = new javax.swing.JLabel();
        jLabel40 = new javax.swing.JLabel();
        jLabel39 = new javax.swing.JLabel();
        lb_payment_pending2 = new javax.swing.JLabel();
        lb_payment_pending3 = new javax.swing.JLabel();
        lb_payment_pending1 = new javax.swing.JLabel();
        ...
        mulit_counter = new javax.swing.JLabel();
        ...
        print_expense_list = new javax.swing.JPanel();
        ...
        Complaint_view.add(Delecte19, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 640, 80, 40));
        ...
        Complaint_view.add(Add_price4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 640, 80, 40));
        ...
        Add_price6.setText("  Appeove");
        Add_price6.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Add_price6MouseClicked(evt);
            }
        });
        Complaint_view.add(Add_price6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 640, 100, 40));
        ...
        Complaint_view.add(Delecte11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 620, 140, 70));

        Add_price7.setFont(new java.awt.Font("Trebuchet MS", 0, 13)); // NOI18N
        Add_price7.setForeground(new java.awt.Color(255, 255, 255));
        Add_price7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hotel/management/images/icons8_plus_math_20px.png"))); // NOI18N
        Add_price7.setText("  Reject");
        Add_price7.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Add_price7MouseClicked(evt);
            }
        });
        Complaint_view.add(Add_price7, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 640, 100, 40));
        ...
        Complaint_view.add(Delecte12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 620, 510, 70));
        ...
        jPanel35.add(jLabel209, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 0, 140, 50));
        ...
        jPanel35.add(jLabel214, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 0, 110, 50));
        ...
        jPanel35.add(jLabel216, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 100, 50));
        ...
        jLabel222.setText(" Due Date");
        jPanel35.add(jLabel222, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 0, 150, 50));

        Complaint_view.add(jPanel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 780, 50));
        ...
        Complaint_view.add(jScrollPane25, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 780, 470));
        ...
        lb_payment_pending4.setFont(new java.awt.Font("Tw Cen MT", 0, 11)); // NOI18N
        lb_payment_pending4.setForeground(new java.awt.Color(255, 255, 255));
        lb_payment_pending4.setText("Week ");
        lb_payment_pending4.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lb_payment_pending4.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_payment_pending4MouseClicked(evt);
            }
        });
        pExpenses.add(lb_payment_pending4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 40, 50, 40));

        lb_payment_pending5.setFont(new java.awt.Font("Tw Cen MT", 0, 11)); // NOI18N
        lb_payment_pending5.setForeground(new java.awt.Color(255, 255, 255));
        lb_payment_pending5.setText("Today");
        lb_payment_pending5.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lb_payment_pending5.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_payment_pending5MouseClicked(evt);
            }
        });
        pExpenses.add(lb_payment_pending5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 40, 40, 40));

        lb_payment_pending6.setFont(new java.awt.Font("Tw Cen MT", 0, 11)); // NOI18N
        lb_payment_pending6.setForeground(new java.awt.Color(255, 255, 255));
        lb_payment_pending6.setText(" Last Month");
        lb_payment_pending6.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lb_payment_pending6.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_payment_pending6MouseClicked(evt);
            }
        });
        pExpenses.add(lb_payment_pending6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 40, 60, 40));
        ...
        pExpenses.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 40, 40, 40));
        ...
        pExpenses.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 40, 40, 40));

        lb_payment_pending2.setFont(new java.awt.Font("Tw Cen MT", 0, 11)); // NOI18N
        lb_payment_pending2.setForeground(new java.awt.Color(255, 255, 255));
        lb_payment_pending2.setText("Week");
        lb_payment_pending2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lb_payment_pending2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_payment_pending2MouseClicked(evt);
            }
        });
        pExpenses.add(lb_payment_pending2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 40, 40, 40));

        lb_payment_pending3.setFont(new java.awt.Font("Tw Cen MT", 0, 11)); // NOI18N
        lb_payment_pending3.setForeground(new java.awt.Color(255, 255, 255));
        lb_payment_pending3.setText("Today");
        lb_payment_pending3.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lb_payment_pending3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_payment_pending3MouseClicked(evt);
            }
        });
        pExpenses.add(lb_payment_pending3, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 40, 60, 40));

        lb_payment_pending1.setFont(new java.awt.Font("Tw Cen MT", 0, 11)); // NOI18N
        lb_payment_pending1.setForeground(new java.awt.Color(255, 255, 255));
        lb_payment_pending1.setText("Last Month");
        lb_payment_pending1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lb_payment_pending1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_payment_pending1MouseClicked(evt);
            }
        });
        pExpenses.add(lb_payment_pending1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 40, 50, 40));
        ...
        pExpenses.add(lb_payment_counter, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 50, 50, 20));
        ...
        lb_payment_pending.setText("All   Request");
        ...
        lb_payments.setText("Pending Expenses");
        lb_payments.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pExpenses.add(lb_payments, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 150, 40));
        ...
        mulit_counter.setFont(new java.awt.Font("Trebuchet MS", 0, 13)); // NOI18N
        mulit_counter.setForeground(new java.awt.Color(255, 255, 102));
        mulit_counter.setText("6");
        mulit_counter.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pExpenses.add(mulit_counter, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 50, 40, 20));
        ...
        lb_students.setText("   Daily Request");
        lb_students.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pExpenses.add(lb_students, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 10, 180, 40));
        ...
        lb_students_pending.setText("Daliy");
        lb_students_pending.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lb_students_pending.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_students_pendingMouseClicked(evt);
            }
        });
        pExpenses.add(lb_students_pending, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 40, 50, 40));
        ...
        jLabel78.setText("   Approved Request");
        jLabel78.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pExpenses.add(jLabel78, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 10, 180, 40));
        ...
        jLabel80.setText("   Rejected Request");
        ...
        pExpenses.add(lb_payment_counter1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 50, 40, 20));
        ...
        Complaint_view.add(pExpenses, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1260, 90));
        ...
        jLabel34.setText("Total Expenses  ");
        ...
        jLabel41.setText("   Monthly Expenses");
        jPanel2.add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 130, 30));

        Complaint_view.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 490, 410, 140));
        ...
        jPanel3.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 90, 80, 30));
        ...
        jLabel31.setText("Total Expenses  ");
        jPanel3.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, 120, 30));
        ...
        jLabel32.setText("   Daily Expenses");
        jPanel3.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 100, 30));

        Complaint_view.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 160, 410, 130));
        ...
        jLabel18.setText("Total Expenses  ");
        ...
        jLabel20.setText("   Weekly Expenses");
        ...
        Complaint_view.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 310, 410, 160));
        ...
        jLabel154.setText("Expenses Entry");
        ...
        jLabel210.setText("  Payment method");
        ...
        subject_entry.add(Count_title39, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 0, 190, 60));
        ...
        print_expense_list.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        jLabel219.setText("Total Expenses");
        ...
        jLabel224.setText(" Due Date");
        jPanel36.add(jLabel224, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 10, 120, 50));

        printable_records.add(jPanel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 920, 60));
        ...
        printable_records.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 30, 330, 40));
        ...
        printable_records.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 780, 920, 10));
        ...
        print_expense_list.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1020, 690));
        ...
        print_expense_list.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 20, 210, 70));

        building_classes_panel.add(print_expense_list, "card4");
    ...
    private void minize_lbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minize_lbMouseClicked
        this.setExtendedState(Admin_Expenses_Approval.ICONIFIED);
    ...
    private void Delecte19MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Delecte19MouseClicked
        ...
        if (subject_selected.equals("none")) {
            JOptionPane.showMessageDialog(null, "Select the Message you wish to view");
             ...
             try {
            conn = DBConnection.getConnction();
            String sql = " SELECT * FROM expenses WHERE (payment_to =? AND description  =?) AND ( Amount  =? AND  Date  =? ) ";
            ...
            if(rs9.next()){
             get_expenses_id = rs9.getString("Expenses_id");
              Delecte_expenses();
            }
        } catch (SQLException ex) {
            Logger.getLogger(Admin_Expenses_Approval.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public void Delecte_expenses() {
    ...
    try {
             conn = DBConnection.getConnction();
             pps3 = conn.prepareStatement("DELETE  FROM  expenses WHERE  Expenses_id = ? ");
             pps3.setString(1, get_expenses_id);
             pps3.executeUpdate();
             JOptionPane.showMessageDialog(null, "Expense Delected" );
    ...
    private void lb_payment_bgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_payment_bgMouseClicked
        try {
            conn = DBConnection.getConnction();
            String sql = "SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE Status = \"Pending\"";
            pps2 = conn.prepareStatement(sql);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
        } catch (SQLException ex) {
    ...
    private void Students_Table_displayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Students_Table_displayMouseClicked
        ...
        DefaultTableModel tableMode_type = (DefaultTableModel) Students_Table_display.getModel();
         ...
         get_Amount = tableMode_type1.getValueAt(Students_Table_display.getSelectedRow(), 3).toString();
         ...
         DefaultTableModel tableMode_type3 = (DefaultTableModel) Students_Table_display.getModel();
           get_description= tableMode_type3.getValueAt(Students_Table_display.getSelectedRow(),2).toString();
    ...
    private void Add_price4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add_price4MouseClicked
          ...
          try {
             conn = DBConnection.getConnction();
             String sql = "SELECT  payment_to,payment_method, description,Amount,Date,Due_date,Expenses_id  FROM expenses WHERE (payment_to = ? AND Date = ?) AND (description = ? OR Amount = ? )";
            ...
            pps4.setString(4 , get_Amount);
             ...
             rs4 = pps4.executeQuery();
              if(rs4.next()){
                ...
                Payment_txt.setText(rs4.getString("payment_to"));
                Payment_method.setText(rs4.getString("payment_method"));
                Amount.setText(rs4.getString("Amount"));
                description .setText(rs4.getString("description"));
                get_Expense_id_toUpdate = rs4.getString("Expenses_id");
              }
    ...
    private void Add_PaidServices1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add_PaidServices1MouseClicked
        ...
        try {
                 conn = DBConnection.getConnction();
                String sql = "UPDATE  expenses SET payment_to =?,payment_method =?, description =? ,Amount =?,Date =? ,Due_date=? WHERE Expenses_id =? ";
                ...
                pps5.setDate(5 ,sqldate );
                pps5.setDate(6 ,sqldate1 );
                
                
                 pps5.setString(7 ,get_Expense_id_toUpdate );
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status FROM expenses WHERE MONTH(date) = MONTH(NOW())";
    ...
    private void jLabel36MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel36MouseClicked
        ...
        Complaint_view.hide();
        panal_Complaint.hide();
        print_expense_list.setVisible(true);
        
        
    }//GEN-LAST:event_jLabel36MouseClicked
String Approve_item = null;
    private void Add_price6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add_price6MouseClicked
        if (subject_selected.equals("none")) {
            JOptionPane.showMessageDialog(null, "Select the Item you wish to Approve");
            ...
            pps4.setString(4 , get_Amount);
             ...
             rs4 = pps4.executeQuery();
              if(rs4.next()){
                   ...
                   Approve_item = rs4.getString("Expenses_id");
              approve_expense();
              }
    ...
    public void approve_expense(){
      Date date = new Date();
        ...
        try {
                 conn = DBConnection.getConnction();
                String sql = "UPDATE  expenses SET Status =?, Approed_Date =? WHERE Expenses_id =? ";
                pps5 = conn.prepareStatement(sql);
                 pps5.setString(1 , new_status );
                 pps5.setDate(2 , sqldate);
                 pps5.setString(3, Approve_item);
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
           try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE  MONTH(Date) = MONTH(NOW()) AND Status = \"Approved\"  ";
            pps6 = conn.prepareStatement(sql);
           // pps6.setString(1, Status);
            rs6 = pps6.executeQuery();
        ...
        try {
            ...
            String Status = "Approved";
            conn = DBConnection.getConnction();
            String sql = " SELECT  sum(Amount)  FROM expenses WHERE   MONTH(Date) = MONTH(NOW())  AND Status = \"Approved\" ";
            pps6 = conn.prepareStatement(sql);
           // pps6.setString(1, Status);
            rs6 = pps6.executeQuery();
           if(rs6.next()){
            jLabel10.setText("K :" +  rs6.getString("sum(Amount)"));
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
           ...
           try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE Status =? AND  YEARWEEK(Date) = YEARWEEK(NOW()) "; //AND Status =?
            pps8 = conn.prepareStatement(sql);
            pps8.setString(1, Status);
            rs8 = pps8.executeQuery();
    ...
    public void countSumWeekly(){
     ...
     try {
            ...
            String Statusd = "Approved";
            conn = DBConnection.getConnction();
            String sql = " SELECT  sum(Amount)   FROM expenses WHERE  YEARWEEK(Date) = YEARWEEK(NOW()) AND Status = \"Approved\"  ";
            pps10 = conn.prepareStatement(sql);
           //pps10.setString(1, Statusd); 
            rs10 = pps10.executeQuery();
           if(rs10.next()){
               String SUM = rs10.getString("sum(Amount)");
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE date =? AND Status =?";
            pps6 = conn.prepareStatement(sql);
            pps6.setDate(1, sqldate);
            pps6.setString(2, Status);
            rs6 = pps6.executeQuery();
            Students_Table_display1.setModel(DbUtils.resultSetToTableModel(rs6));
        } catch (SQLException ex) {
            Logger.getLogger(Admin_Expenses_Approval.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT  sum(Amount)   FROM expenses WHERE date =? AND Status =?";
            pps6 = conn.prepareStatement(sql);
            pps6.setDate(1, sqldate);
            pps6.setString(2, Status);
            rs6 = pps6.executeQuery();
           if(rs6.next()){
            ...
            Logger.getLogger(Admin_Expenses_Approval.class.getName()).log(Level.SEVERE, null, ex);
                 ...
                 String reject_expense_item = null;
            ...
            pps4.setString(4 , get_Amount);
             ...
             rs4 = pps4.executeQuery();
              if(rs4.next()){
                  ...
                  reject_expense_item = rs4.getString("Expenses_id");
              reject_expense();
              }
    ...
    private void jLabel39MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel39MouseClicked
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE  YEARWEEK(date) = YEARWEEK(NOW()) AND Status = \"Pending\" ";
            pps2 = conn.prepareStatement(sql);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
        } catch (SQLException ex) {
            ...
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE  YEARWEEK(date) = YEARWEEK(NOW()) AND Status = \"Pending\"");
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
                mulit_counter.setText(sum);
    ...
    private void jLabel40MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel40MouseClicked
      try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status FROM expenses WHERE MONTH(date) = MONTH(NOW()) AND Status = \"Pending\" ";
            pps3 = conn.prepareStatement(sql);
            rs3 = pps3.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs3));
        } catch (SQLException ex) {
            ...
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE MONTH(date) = MONTH(NOW()) AND Status = \"Pending\" ");
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
                mulit_counter.setText(sum);
    ...
    private void lb_students_pendingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_students_pendingMouseClicked
           Date date = new Date();
             java.sql.Date sqldate = new java.sql.Date(date.getTime());
        ...
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE date =? AND Status = \"Pending\"";
            pps2 = conn.prepareStatement(sql);
            ...
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE date =? AND Status = \"Pending\" ");
    ...
    }//GEN-LAST:event_lb_students_pendingMouseClicked

    private void lb_payment_pending1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_payment_pending1MouseClicked
         try {
            
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status FROM expenses WHERE MONTH(date) = MONTH(NOW() - INTERVAL 1 MONTH)  AND Status = \"Approved\" ";
            pps2 = conn.prepareStatement(sql);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
        } catch (SQLException ex) {
          ...
          ///count
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE MONTH(date) = MONTH(NOW() - INTERVAL 1 MONTH)  AND Status = \"Approved\" ");
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
    ...
    }//GEN-LAST:event_lb_payment_pending1MouseClicked

    private void lb_payment_pending2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_payment_pending2MouseClicked
          try {
            
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE  YEARWEEK(date) = YEARWEEK(NOW() - INTERVAL 1 WEEK) AND Status = \"Approved\"";
            pps2 = conn.prepareStatement(sql);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
        } catch (SQLException ex) {
         ...
         ///count
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE YEARWEEK(date) = YEARWEEK(NOW() - INTERVAL 1 WEEK) AND Status = \"Approved\" ");
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
                lb_payment_counter.setText(sum);
    ...
    }//GEN-LAST:event_lb_payment_pending2MouseClicked

    private void lb_payment_pending3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_payment_pending3MouseClicked
          Date date = new Date();
             java.sql.Date sqldate = new java.sql.Date(date.getTime());
        ...
        try {
            ...
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE date =? AND Status = \"Approved\"";
            pps2 = conn.prepareStatement(sql);
            pps2.setDate(1, sqldate);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
            ...
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE date =? AND Status = \"Approved\" ");
             pps10.setDate(1, sqldate);
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
    ...
    }//GEN-LAST:event_lb_payment_pending3MouseClicked

    private void lb_payment_pending6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_payment_pending6MouseClicked
             try {
            
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status FROM expenses WHERE MONTH(date) = MONTH(NOW() - INTERVAL 1 MONTH)  AND Status = \"Rejected\" ";
            pps2 = conn.prepareStatement(sql);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
        } catch (SQLException ex) {
          ...
          ///count
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE MONTH(date) = MONTH(NOW() - INTERVAL 1 MONTH)  AND Status = \"Rejected\" ");
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
    ...
    }//GEN-LAST:event_lb_payment_pending6MouseClicked

    private void lb_payment_pending4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_payment_pending4MouseClicked
            try {
            
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE  YEARWEEK(date) = YEARWEEK(NOW() - INTERVAL 1 WEEK) AND Status = \"Rejected\"";
            pps2 = conn.prepareStatement(sql);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
        } catch (SQLException ex) {
         ...
         ///count
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE YEARWEEK(date) = YEARWEEK(NOW() - INTERVAL 1 WEEK) AND Status = \"Rejected\" ");
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
                lb_payment_counter1.setText(sum);
    ...
    }//GEN-LAST:event_lb_payment_pending4MouseClicked

    private void lb_payment_pending5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_payment_pending5MouseClicked
          Date date = new Date();
             java.sql.Date sqldate = new java.sql.Date(date.getTime());
        ...
        //    mulit_counter
            conn = DBConnection.getConnction();
            String sql = " SELECT payment_to,payment_method, description,Amount,Due_date,Status  FROM expenses WHERE date =? AND Status = \"Rejected\"";
            pps2 = conn.prepareStatement(sql);
            pps2.setDate(1, sqldate);
            rs2 = pps2.executeQuery();
            Students_Table_display.setModel(DbUtils.resultSetToTableModel(rs2));
            ...
            try {
           conn = DBConnection.getConnction();
            pps10 = conn.prepareStatement("SELECT count(Expenses_id) FROM expenses WHERE date =? AND Status = \"Rejected\" ");
             pps10.setDate(1, sqldate);
            rs10 = pps10.executeQuery();
            if (rs10.next()) {
                String sum = rs10.getString("count(Expenses_id)");
    ...
    }//GEN-LAST:event_lb_payment_pending5MouseClicked
   
    
    
    public void reject_expense(){
      Date date = new Date();
         java.sql.Date sqldate = new java.sql.Date(date.getTime());
        ...
        try {
                ...
                pps5 = conn.prepareStatement(sql);
                 pps5.setString(1 , new_status );
                 pps5.setDate(2 , sqldate);
                 pps5.setString(3, reject_expense_item);
     ...
     public static Admin_Expenses_Approval getObj() {  //public method for instance Restriction
        if (Obj == null) {
            Obj = new Admin_Expenses_Approval();
        }
        return Obj;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Expenses_Approval.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Expenses_Approval().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lb_payment_pending1;
    private javax.swing.JLabel lb_payment_pending2;
    private javax.swing.JLabel lb_payment_pending3;
    private javax.swing.JLabel lb_payment_pending4;
    private javax.swing.JLabel lb_payment_pending5;
    private javax.swing.JLabel lb_payment_pending6;
    ...
    private javax.swing.JLabel mulit_counter;
    private javax.swing.JLabel name;
    private javax.swing.JPanel pExpenses;
    private javax.swing.JPanel panal_Complaint;
    private javax.swing.JPanel print_expense_list;
